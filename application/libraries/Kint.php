...
/*
 * Wrapper of var_dump, provides enhanced debugging-display output of var_dump
 * */
...
class Kint
{
	...
	public static function enabled( $value = NULL )
	{
		...
		if ($CI->config->item('kint_settings')) {
			$defaults = array(
			...
			$settings = $CI->config->item('kint_settings');
...
/* Location: ./application/libraries/Kint.php */