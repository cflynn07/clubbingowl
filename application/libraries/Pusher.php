...
class Pusher
{
	...
	* @return bool|string
	*/
	public function trigger_async( $channel, $event, $payload, $socket_id = null, $debug = false, $already_encoded = false )
	{
		...
		$this->CI->load->helper('curl_request_async');
		
		curl_request_async($full_url, $payload_vencoded);

		return true; //just assume it works...
