 ...
 * 
 */
class Net_Gearman_Job_admin_promoter_piwik_stats extends Net_Gearman_Job_Common{
    ...
    public function run($args){
		...
		echo 'Promoter piwik stats recieved for piwik_site_id: '	. $piwik_id_site . PHP_EOL;
