<?php
	...
	foreach($ejs_templates as $ejst){
		$ejs_view_templates->$ejst = $this->load->view('dynamic_assets/ejs/admin_managers/' . $ejst, array('lang_code' => $lang), true);
	}
	$ejs_view_templates = json_encode($ejs_view_templates);
?>
(function(exports){
	exports.ejs_view_templates_admin_managers = <?= $ejs_view_templates ?>;	
})(window);