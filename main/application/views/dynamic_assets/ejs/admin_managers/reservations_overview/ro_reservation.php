...
<td>
	...
	<% } %>		
		...
		<% }else{ %>
			...
			<a class="ajaxify" href="<%= window.module.Globals.prototype.front_link_base + 'admin/managers/clients/' + head_user + '/' %>"><span data-oauth_uid="<%= head_user %>" data-name="<%= head_user %>"></span></a>
