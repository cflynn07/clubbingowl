								...
								<ul class="sitemap ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all" style="cursor: default;">
									...
									?>
										<?php foreach($promoter->weekly_guest_lists as $wgl): ?>
											...
											<li style="margin-left:15px; text-decoration:none;"><span style="text-decoration:underline"><?= $wgl->pgla_name ?></span> (<?= count($wgl->groups) ?>)<span class="pgla_id" style="display:none"><?= $wgl->pgla_id ?></span></li><br>
