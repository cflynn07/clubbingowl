...
<div style="width:1050px; margin-bottom:40px;">
	...
	<div class="full_width last">
		...
		<form>
			...
			<input id="campaign_title" type="text" style="width:200px; border:1px solid #CCC;" />
		</form>
		
		<div>
			<label>Campaign Body:</label><br>
			<textarea id="inputcledit"></textarea>
		</div>
	</div>
	
	<div class="full_width last">
		<h2>Preview</h2>
		<div class="email_preview" style="width:600px;">
	                                                    ...
	                                                    <tr>
	                                                        <td valign="top" style="padding-right:0;">
	                                                            <div mc:edit="std_content00">
	                                                            	...
	                                                            	<table >
	                                                            		<tr>
	                                                            			<td style="padding:5px;" id="content_preview_td"></td>
	                                                            		</tr>
	                                                            		<tr>
	...
	<div class="one_half last">
		...
		<table class="normal" style="width:100%;">
			<thead>
				<tr>
					<th class="header">Circulation</th>
					<th class="header">Cost</th>
				</tr>
			</thead>
			<tbody>
				<tr>
					<td><?= count($data->clients) ?></td>
					<td>$<?= ceil(count($data->clients) * 0.03) ?></td>
				</tr>
			</tbody>
		</table>
		<a id="send_campaign" class="button_link" href="javascript: void(0);">Send Campaign</a><br><br>
	</div>
	
	
	<div style="display:none;" id="confirm_dialog">
		<p>
			Campaign will be sent to <?= count($data->clients) ?> clients.<br>
			Cost: $<?= ceil(count($data->clients) * 0.03) ?>
			
			<img class="loading_indicator" style="display:none;margin-left:auto;margin-right:auto;margin-top:20px;" src="<?=$central->global_assets . 'images/ajax.gif'?>" alt="loading..." />
			
		</p>
	</div>
	
	<a id="back_btn" class="ajaxify" style="display:none;" href="<?= $central->manager_admin_link_base . 'marketing/' ?>">Back</a>
