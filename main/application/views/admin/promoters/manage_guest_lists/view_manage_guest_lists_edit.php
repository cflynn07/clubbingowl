...
<div class="" style="width:1050px; margin-bottom:40px;">
	...
	<form id="guest_list_new_form">
		...
		<div style="clear:both;"></div>
			...
			<input style="width:50px;" name="guest_list_reg_cover" value="<?= $guest_list->pgla_regular_cover ?>"></input>
		</p>
			<p>
			<label>Guest-list Cover:</label>
			<input style="width:50px;" name="guest_list_gl_cover" value="<?= $guest_list->pgla_gl_cover ?>"></input>
		</p>
			<p>
			...
			<input style="width:250px;" name="guest_list_additional_info_1" value="<?= $guest_list->pgla_additional_info_1 ?>"></input>
		</p>
			<p>
			<label>Additional Info 2:</label>
			<input style="width:250px;" name="guest_list_additional_info_2" value="<?= $guest_list->pgla_additional_info_2 ?>"></input>
		</p>
			<p>
			<label>Additional Info 3:</label>
			<input style="width:250px;" name="guest_list_additional_info_3" value="<?= $guest_list->pgla_additional_info_3 ?>"></input>
		</p>
