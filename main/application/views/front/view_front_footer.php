		...
		<div class="center">
			...
			<div class="half">
				...
				<div style="border-top:1px dashed #CCC;">
					<h2 style="margin-top:10px;"><a target="_new" href="http://solutions.clubbingowl.com/">ClubbingOwl Promotional Management Software</a></h2>
					<table style="position:relative;top:-10px;">
						<tr>
							...
							<td style="padding-left:10px; vertical-align:top;">
								<p style="margin:0; font-size:13px; color:#FFF;"><strong>The most advanced venue management and marketing software.</strong> Leverage the power of Facebook to virally grow your guest-lists and events while managing your clientelle database, VIP reservations, floorplan-layouts, email marketing campaigns, promotional staff, and much more!</p>
							</td>
						</tr>
					</table>
				</div>
