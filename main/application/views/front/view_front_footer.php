					...
					<table style="position:relative;top:-10px;">
						<tr>
							...
							<td style="padding-left:10px; vertical-align:top;">
								<p style="margin:0;font-size:13px;"><strong>The most advanced venue management and marketing software.</strong> Manage your clientelle database, VIP reservations, floorplan-layouts, email marketing campaigns, promoter performance tracking, and much more!</p>
							</td>
						</tr>
					</table>
				</div>
