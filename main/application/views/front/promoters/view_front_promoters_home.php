<?php if($city): // ----------------- specific city ---------------------- ?>
	...
	<ul class="venue-list" style="margin-top:20px;">
		...
		<li>
			<a class="ajaxify_t3" href="<?=$central->front_link_base?>promoters/<?= $pro->c_url_identifier ?>/<?= $pro->up_public_identifier ?>/guest_lists/">
		    ...
		    <div class="name_block" style="display:inline-block;clear:right;">
			    <a class="ajaxify_t3" href="<?=$central->front_link_base?>promoters/<?= $pro->c_url_identifier ?>/<?= $pro->up_public_identifier ?>/guest_lists/"><?= $pro->u_full_name ?></a>
