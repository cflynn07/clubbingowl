...
<html>
    <head>
        ...
        <title><?= $email_data->message_title ?></title>
		<style type="text/css">
			...
			*/
			body, #backgroundTable{
				/*@editable*/ background-color:rgb(240, 240, 240);
			}
			...
			*/
			#templatePreheader{
				/*@editable*/ background-color:rgb(76, 76, 76);
			}
                                                        ...
                                                        <td valign="top" style="padding-right:0;">
                                                            <div mc:edit="std_content00">
                                                            	...
                                                            	<?php 
                                                    				...
                                                    				if($email_data->type == 'team'){
																		
																		$gl_message = 'the guest list "' . $email_data->gl_query->tgla_name . '" at ' . $email_data->gl_query->tv_name . '!';
																		$gl_image = 'http://d1pv30wi5cq71r.cloudfront.net/vc-images/guest_lists/' . $email_data->gl_query->tgla_image . '_p.jpg';
																		$tv_image = 'http://d1pv30wi5cq71r.cloudfront.net/vc-images/venues/banners/' . $email_data->gl_query->tv_image . '_p.jpg';
																		
                                                    				}elseif($email_data->type == 'promoter'){
                                                    					
																		$gl_message = $email_data->gl_query->u_full_name . '\'s guest list "' . $email_data->gl_query->pgla_name . '" at ' . $email_data->gl_query->tv_name;
																		$gl_image = 'http://d1pv30wi5cq71r.cloudfront.net/vc-images/guest_lists/' . $email_data->gl_query->pgla_image . '_p.jpg';
																		$tv_image = 'http://d1pv30wi5cq71r.cloudfront.net/vc-images/venues/banners/' . $email_data->gl_query->tv_image . '_p.jpg';
																		$promoter_image = 'http://d1pv30wi5cq71r.cloudfront.net/vc-images/profile-pics/' . $email_data->gl_query->up_profile_image . '_p.jpg';
                                                            	...
                                                            	<table >
                                                            		<tr>
                                                            			<td colspan="2" ><img style="width:100%;margin-top:5px;margin-bottom:5px;" src="<?= $tv_image ?>" /></td>
                                                            		</tr>
                                                            		...
                                                            		<tr>
                                                            			...
                                                            			<td style="vertical-align:top;font-size:18px;">Your friend <strong style="color: #3CA6E2"><a href="http://www.vibecompass.com/friends/<?= $email_data->from_user->u_third_party_id ?>/" ><?= $email_data->from_user->u_full_name ?></a></strong> has joined <?= $gl_message ?></td>
                                                            		</tr>
                                                            		...
                                                            		<tr>
                                                            			<?php if(isset($promoter_image)): ?>
                                                            			<td><img src="<?= $promoter_image ?>" /></td>
                                                            			<?php endif; ?>
                                                            			<td><img src="<?= $gl_image ?>" /></td>
                                                            		</tr>
                                                            	</table>
