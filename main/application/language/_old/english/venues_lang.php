...
$lang["v-jpgl"]		= "<%= user_friend.first_name + ' ' + user_friend.last_name %> joined <%= inline_link('promoters/' + ((notification_data.c_url_identifier) ? notification_data.c_url_identifier : 'boston') + '/' + notification_data.up_public_identifier, notification_data.u_full_name, {}) %>'s guest list \"<%= inline_link('promoters/' + ((notification_data.c_url_identifier) ? notification_data.c_url_identifier : 'boston') + '/' + notification_data.up_public_identifier + '/guest_lists/' + pi_link_convert(notification_data.pgla_name), notification_data.pgla_name) %>\"";
