...
|
*/
$config['encryption_key'] = '1K&sdfa4ga3ac3934bae(*)$T$FD@D@G';
...
$config['sess_time_to_update']  = 60 * 60 * 6; //six hours
...
if(isset($_SERVER['REQUEST_URI'])
		&& ( (strpos($_SERVER['REQUEST_URI'], '/facebook') === 0) || (strpos($_SERVER['REQUEST_URI'], '/twilio') === 0) )){
	//Facebook access to this url, CSRF fucks up facebook apps so leave it off
