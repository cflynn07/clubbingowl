		...
		if($this->client_type) 
		{
			...
			switch($this->client_type)
			{
				case 'Memcached':
					...
					$this->m->setOption(Memcached::OPT_BINARY_PROTOCOL, 1);					
...
/* End of file library_memcached.php */
/* Location: ./application/libraries/library_memcached.php */