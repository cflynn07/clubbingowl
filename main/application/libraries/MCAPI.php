...
class MCAPI {
    ...
    */
     ...
     */
    public function listSubscribe($id, $email_address, $merge_vars, $email_type='html', $double_optin=false, $update_existing=false, $replace_interests=true, $send_welcome=true) {
        $params = array();
        $params["id"] = $id;
        $params["email_address"] = $email_address;
